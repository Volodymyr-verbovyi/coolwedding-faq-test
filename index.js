    ...
    bot.on('message', async msg => {
        ...
        switch (msg.text) {
            ...
            case kb.home.weddingSite:
                await bot.sendMessage(chatId, `Свадебный сайт, это онлайн приглашение на свадьбу. Онлайн приглашение, размещенное на сайте, это одновременно и Ваша уникальная история и созданное лично Вами обращение к гостям. Возможность быстро отправить и проинформировать гостей о деталях мероприятия, каких либо изменений или дополнений. Приглашение всегда доступно по ссылке которую вы отправите, одинаково красиво выглядит в компьютере или телефоне. Примеры можете псмотреть как раз внизу 👇🏽`,
                    {
