...
var questions = [
    ...
    {
        title:'Чему равно 6636363 true ?',
        buttons: [
            [{ text: 'Ровно столько, сколько указано в определении функции.', callback_data: '2_1' }],
            [{ text: '45', callback_data: '2_2' }],
            [{ text: '4', callback_data: '2_3' }],
            [{ text: 'true', callback_data: '2_4' }]
        ],
        right_answer: 3
    },
